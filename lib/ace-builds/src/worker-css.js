...
window.define = function(id, deps, factory) {
    ...
    if (!deps.length)
        // If there is no dependency, we inject 'require', 'exports' and
        // 'module' as dependency, to provide CommonJS compatibility.
        ...
        factory: function() {
            ...
            var returnExports = factory.apply(this, deps.map(function(dep) {
              switch(dep) {
                  ...
                  // dependency, we must handle them seperately.
                  case 'require': return req;
                  case 'exports': return module.exports;
                  case 'module':  return module;
                  // But for all other dependency, we can just go ahead and
                  // require them.
...
CSSLint.addRule({
    ...
    init: function(parser, reporter){
        ...
        parser.addListener("endstylesheet", function(){
            ...
            if (count >= 10){
                reporter.rollupWarn("Too many !important declarations (" + count + "), try to use less than 10 to avoid specificity issue.", rule);
            }
        });
    }
