...
(function (module) {
    ...
    module.controller("issuesCriticalFilesTreeMapCtrl", issuesCriticalFilesTreeMapCtrl);

    issuesCriticalFilesTreeMapCtrl.$inject = ['$scope','issuesChartSvc'];

    function issuesCriticalFilesTreeMapCtrl($scope, issuesChartSvc) {
