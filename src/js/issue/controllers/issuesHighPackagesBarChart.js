...
(function (module) {
    ...
    module.controller("issuesHighPackagesBarChartCtrl", issuesHighPackagesBarChartCtrl);

    issuesHighPackagesBarChartCtrl.$inject = ['$scope','issuesChartSvc'];

    function issuesHighPackagesBarChartCtrl($scope, issuesChartSvc) {
