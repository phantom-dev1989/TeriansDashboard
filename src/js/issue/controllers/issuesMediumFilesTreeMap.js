...
(function (module) {
    ...
    module.controller("issuesMediumFilesTreeMapCtrl", issuesMediumFilesTreeMapCtrl);

    issuesMediumFilesTreeMapCtrl.$inject = ['$scope','issuesChartSvc'];

    function issuesMediumFilesTreeMapCtrl($scope, issuesChartSvc) {
