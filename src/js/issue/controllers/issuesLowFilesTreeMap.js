...
(function (module) {
    ...
    module.controller("issuesLowFilesTreeMapCtrl", issuesLowFilesTreeMapCtrl);

    issuesLowFilesTreeMapCtrl.$inject = ['$scope','issuesChartSvc'];

    function issuesLowFilesTreeMapCtrl($scope, issuesChartSvc) {
