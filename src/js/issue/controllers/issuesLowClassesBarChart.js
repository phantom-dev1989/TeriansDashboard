...
(function (module) {
    ...
    module.controller("issuesLowClassesBarChartCtrl", issuesLowClassesBarChartCtrl);

    issuesLowClassesBarChartCtrl.$inject = ['$scope','issuesChartSvc'];

    function issuesLowClassesBarChartCtrl($scope, issuesChartSvc) {
