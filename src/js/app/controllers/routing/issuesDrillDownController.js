...
(function (module) {
    ...
    module.controller("issuesDrillDownCtrl", issuesDrillDownCtrl);

    issuesDrillDownCtrl.$inject = ['$scope', 'scanSvc', 'moment','issues'];

    function issuesDrillDownCtrl($scope, scanSvc, moment, issues) {
