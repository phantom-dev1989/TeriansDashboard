...
(function (module) {
    ...
    module.controller("criticalIssuesCtrl", criticalIssuesCtrl);

    criticalIssuesCtrl.$inject = ['$scope', 'scanSvc', 'moment','issues'];

    function criticalIssuesCtrl($scope, scanSvc, moment, issues) {
