...
(function (module) {
    ...
    module.controller("mediumIssuesCtrl", mediumIssuesCtrl);

    mediumIssuesCtrl.$inject = ['$scope', 'scanSvc', 'moment','issues'];

    function mediumIssuesCtrl($scope, scanSvc, moment, issues) {
